        ...
        <View style={styles.modalContent}>
          ...
          <ScrollView style={styles.scrollView}>
            ...
            <TouchableOpacity
              ...
              onPress={() => toggleSection("province")}
            >
              <Text style={styles.accordionTitle}>Tỉnh thành</Text>
              <Ionicons
                name={expandedSections.province ? "chevron-up" : "chevron-down"}
                size={20}
                color="#4A5568"
              />
            </TouchableOpacity>
            ...
            {expandedSections.province && (
              <View style={styles.accordionContent}>
                <Picker
                  ...
                  onValueChange={(value) =>
                    handleLocalFilterChange("province", value)
                  }
            ...
            <TouchableOpacity
              style={styles.accordionHeader}
              onPress={() => toggleSection("workshopType")}
            >
              <Text style={styles.accordionTitle}>Loại xưởng</Text>
              <Ionicons
                name={
                  expandedSections.workshopType ? "chevron-up" : "chevron-down"
                }
                size={20}
                color="#4A5568"
              />
            ...
            {expandedSections.workshopType && (
              <View style={styles.accordionContent}>
                <Picker
                  selectedValue={localFilters.workshopType}
                  onValueChange={(value) =>
                    handleLocalFilterChange("workshopType", value)
                  }
                  style={styles.picker}
                >
                  <Picker.Item label="Chọn loại xưởng" value="" />
                  <Picker.Item label="Xưởng vàng" value="Gold" />
                  <Picker.Item label="Xưởng bạc" value="Silver" />
                  <Picker.Item label="Xưởng đồng" value="Bronze" />
                </Picker>
              </View>
            )}
            ...
            >
              <Text style={styles.accordionTitle}>Lọc theo giá</Text>
              <Ionicons
            ...
            {expandedSections.price && (
              <View style={styles.accordionContent}>
                <View style={styles.priceRangeContainer}>
                  <Text style={styles.rangeText}>Giá tối thiểu:</Text>
                ...
                <Slider
                  ...
                  onValueChange={(value) =>
                    handleLocalFilterChange("priceRange", [
                      value,
                      Math.max(value, localFilters.priceRange[1]),
                    ])
                  }
                ...
                <View style={styles.priceRangeContainer}>
                  <Text style={styles.rangeText}>Giá tối đa:</Text>
                  <Text style={styles.rangeValue}>
            ...
            <View style={styles.section}>
              ...
              >
                ...
                <Picker.Item label="Giá: Thấp đến cao" value="price-asc" />
                <Picker.Item label="Giá: Cao đến thấp" value="price-desc" />
            ...
            {/* Tìm kiếm */}
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Tìm kiếm sản phẩm</Text>
              <TextInput
